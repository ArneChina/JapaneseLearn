...
$(function() { $('.circle').each(function(index, el) { var num = $(this).find('span').text() * 3.6; if (num<=180) { $(this).find('.right').css('transform', "rotate(" + num + "deg)"); } else { $(this).find('.right').css('transform', "rotate(180deg)"); $(this).find('.left').css('transform', "rotate(" + (num - 180) + "deg)"); }; }); });
   ...
   var i=1;
   var buts1=document.getElementById("button-list1");
   var buts2=document.getElementById("button-list2");
   var dis=document.getElementById("word-test");
   var dis2=document.getElementById("word-information");
   var dis3=document.getElementById("point");
function display1(){
	dis3.style.display="block";
	if(i==1)
	{
		var divs = document.getElementById("point1");
        divs.style.display="block";
		divs.style.background="#70AACD";
    } 
	else if(i==2){
		var divs = document.getElementById("point2");
		var divss = document.getElementById("point1");
        divs.style.display="block";
		divs.style.background="#7eaedc";
		divss.style.background="white";
	}
    else if(i==3){
		var divs = document.getElementById("point3");
		var divss = document.getElementById("point2");
        divs.style.display="block"; 
		buts1.style.display="none";
        buts2.style.display="block";
		divs.style.background="#7eaedc";
		divss.style.background="white";
	}
	i++;
